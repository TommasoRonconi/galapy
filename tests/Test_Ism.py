...
def test_ism_mc_temperature ( ism ) :
    ...
    E_tot = 4.e+43
    assert ism.mc.temperature( E_tot ) == pytest.approx( 16.425235654676634 )
...
def test_ism_mc_emission ( ism ) :
    ...
    assert np.all ( ism.mc.emission( ll ) == pytest.approx( [ 2.31063719e-09,
                                                              9.13901527e+03,
                                                              7.17340761e+04,
                                                              3.08445892e+02,
                                                              2.04499207e-01,
