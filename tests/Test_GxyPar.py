...
def test_gxp_default_params ( gxp ) :
    ...
    assert gxp.parameters == pytest.approx({
        'galaxy.age': 1000000.0,
        'galaxy.redshift': 0.0,
...
def test_gxp_invalid_value ( recwarn ) :
    ...
    assert gxp.parameters['galaxy.age'] == pytest.approx( 1.e+6 )
...
def test_gxp_params_fixed () :
    ...
    assert gxp.parameters[ 'galaxy.age' ] == pytest.approx( 1.e+8 )
    assert gxp.parameters[ 'galaxy.ism.f_MC' ] == pytest.approx( 0.6 )
