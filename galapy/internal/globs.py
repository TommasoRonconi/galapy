...
bc03_basel_chab_zeros  = os.path.join( BC03, 'basel_chab_zero_extended.dat' )

# Stelib (High Resolution) SSP + Chabrier IMF + null extension
bc03_stelib_chab_zeros  = os.path.join( BC03, 'stelib_chab_zero_extended.dat' )

# Stelib (High Resolution) SSP + Chabrier IMF + extrapolation
bc03_stelib_chab_extrap = os.path.join( BC03, 'stelib_chab_extrap.dat' )
